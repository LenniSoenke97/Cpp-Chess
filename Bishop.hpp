...
public:
  ...
  /*
   * Bishop Constructor
   * Description: constructor of bishop, sets the colour of bishop and calls parent
   *              class constructor
  ...
  /*
   * Description: canMakeMove returns whether a bishop on a certain source field can make
   *              a move to a given destination field. The function checks whether the 
   *              destination field is diagonal from the source field and that no other
   *              figures are in the way.
   * Input:       ChessField* source: the chess field that the bishop you want to move is on
   *              ChessField* destination: the chess field you want to move the bishop to
