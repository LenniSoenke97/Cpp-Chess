...
public:
  ...
  /*
   * Knight Constructor
   * Description: constructor of knight, sets the colour of knight and calls 
  ...
  /*
   * Description: canMakeMove returns whether a knight on a certain source 
   *              field can make a move to a given destination field. 
   * Input:       ChessField* source: the chess field that the knight you want 
   *              to move is on
